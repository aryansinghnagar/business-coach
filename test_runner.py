...
For a GUI with detailed failure analysis, use the launcher (Tests tab):
  python launcher.py

Usage: python test_runner.py [--verbose] [pattern]
...
def run_tests(verbose=False, pattern=None):
    ...
    # Single consolidated test file at project root
