/**
 * Avatar Chat Manager Module (text-only mode).
 *
 * Manages chat UI and streaming responses. speak() is a no-op when avatarSynthesizer
 * is null (avatar/TTS removed; insights are text-only). Works in parallel with engagement detection.
 */
