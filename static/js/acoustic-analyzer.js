/**
 * Client-side acoustic analyzer for meeting partner (or mic) audio.
 * Computes windowed features: RMS (loudness), pitch (F0 via CREPE or FFT fallback),
 * contour, variability, tone proxy, voicing confidence.
 * POSTs to POST /engagement/acoustic-context when speech is active.
 * Research: Scherer, Bachorowski, Ladd; CREPE (Kim et al.) for robust pitch.
 */
