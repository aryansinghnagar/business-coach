 ...
 *
 * Displays expression signifier scores on a continuous 0-100 scale in four groups
 * beneath the avatar chat. Each metric shows a label, a bar (width = score%), and the
 * numeric score. Color bands: 0-39 muted, 40-69 medium, 70-100 high. No "detected" /
 * "not detected" labels; all values are continuous.
 */
...
var SIGNIFIER_LABELS = {
    ...
    g2_brow_furrow_deep: 'Brow Furrow Deep',
