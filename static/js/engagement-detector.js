 ...
 * feed STT → POST /engagement/transcript). Visual and speech cues are combined for
 * B2B meeting insights; popup messages are generated by Azure AI Foundry (see docs/DOCUMENTATION.md).
 *
 * Features:
 * - Start/stop engagement detection (video path)
 * - Poll engagement state from backend
 * - Spike alerts: popup (text only)
